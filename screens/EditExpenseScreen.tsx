...
import { insertRecord, updateRecord } from "../util/database";

function EditExpenseScreen() {
    const navigation = useNavigation<NativeStackNavigationProp<any>>();
    const route = useRoute<any>();
    const { idFromComponent, titleFromComponent, dateFromComponent, amountFromComponent } = route.params;
    const [showDate, setShowDate] = useState(false);
    const [title, setTitle] = useState(titleFromComponent);
    const [amount, setAmount] = useState(amountFromComponent);
    const [date, setDate] = useState(new Date(dateFromComponent));
    ...
    async function handleUpdateExpense() {
        await updateRecord(idFromComponent, title, amount, String(date))
        Keyboard.dismiss();
    }
        ...
        <SafeAreaView style={styles.root}>
            <View style={styles.container}>
                <View style={styles.titleContainer}>
                    ...
                    <Text style={styles.titleText}>Edit record</Text>
                </View>
                <View>
                    <CustomTextInput
                        value={title}
